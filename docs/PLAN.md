...
- **Define translations pad in unselected context words; results vary between identical requests.** Paused mid-investigation 2026-06-16 — see below for full state. Awaiting a decision on fix scope before resuming.
